          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo URL;?>pages"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                <li><a href="<?php echo URL;?>pages"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              <a href="#">
                ...
                <span><?= $temas['texto']?></span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <?php foreach ($temas['contenido'] as $subtemas):?>
                <li><a href="<?= $subtemas['url'] ?>"><i class="fa fa-circle-o"></i> <?= $subtemas['texto'] ?></a></li>
                <?php endforeach;?>
              </ul>
            </li>
            <?php endforeach;?>
